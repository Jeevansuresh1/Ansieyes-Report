...
\end{tikzpicture}
\caption{Layered architecture of Ansieyes}
\vspace{2mm}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.95\textwidth]{Figures/report_image_1}
\caption{DFD-0 of Ansieyes AI-Powered Issue Triage and PR Review System Context Diagram}
\vspace{2mm}
\label{fig:dfd0}
\end{figure}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.95\textwidth]{Figures/report_image_2}
\caption{DFD-1 of Ansieyes AI-Powered Issue Triage and PR Review System Decomposition}
\vspace{2mm}
\label{fig:dfd1}
\end{figure}
...
\caption{\textbf{Core data models and their fields}}
\vspace{2mm}
\label{tab:models}
...
\end{tikzpicture}
\caption{Two-pass Librarian--Surgeon flow}
\vspace{2mm}
\label{fig:twopass}
\end{figure}
...
\end{tikzpicture}
\caption{Multi-layered prompt injection detection pipeline}
\vspace{2mm}
\label{fig:security}
\end{figure}
