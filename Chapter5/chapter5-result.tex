...
\caption[Issue classification accuracy by type]{\textbf{Issue classification accuracy by type}}
\vspace{2mm}
...
\setlength{\arrayrulewidth}{0.5mm}
\fontsize{10}{12}\selectfont
\caption[Distribution of confidence scores]{\textbf{Distribution of confidence scores}}
\vspace{2mm}
...
\setlength{\arrayrulewidth}{0.5mm}
\fontsize{10}{12}\selectfont
\caption[Duplicate detection: Gemini vs. Cosine similarity]{\textbf{Duplicate detection: Gemini vs. Cosine similarity}}
\vspace{2mm}
\label{tab:dupcomp}
...
\setlength{\arrayrulewidth}{0.5mm}
\fontsize{10}{12}\selectfont
\caption[Injection detection rates by category]{\textbf{Injection detection rates by category}}
\vspace{2mm}
\label{tab:injection}
\begin{tabular}{|p{3.5cm}|c|c|c|}
\hline
...
\setlength{\arrayrulewidth}{0.5mm}
\fontsize{10}{12}\selectfont
\caption[Token consumption: single-pass vs. two-pass]{\textbf{Token consumption: single-pass vs. two-pass}}
\vspace{2mm}
\label{tab:tokens}
...
\setlength{\arrayrulewidth}{0.5mm}
\fontsize{10}{12}\selectfont
\caption[Execution time by operation]{\textbf{Execution time by operation}}
\vspace{2mm}
\label{tab:timing}
