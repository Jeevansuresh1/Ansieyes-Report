...
\begin{tabular}{cccc}
	\Large &&&\\
		& &&\\
	\large Project Guide &\large Head of the Department &\large Dean, CS Cluster &\large Principal\\
	& &&\\
	\large Prof. Savitri Kulkarni & \large\printHOD & \large Dr. Ramakanth Kumar P & \large\printPrincipal\\
	& && \\
\end{tabular}%
}
\end{table}
