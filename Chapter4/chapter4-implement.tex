...
\caption{\textbf{Project directory layout}}
\vspace{2mm}
...
\section{\textbf{Core Analysis Engine}}
...
\section{\textbf{Prompt Injection Detection}}
...
\setlength{\arrayrulewidth}{0.5mm}
\fontsize{10}{12}\selectfont
\caption{\textbf{Prompt injection pattern categories and assigned confidence levels}}
\vspace{2mm}
\label{tab:patterns}
...
\section{\textbf{Duplicate Detection}}
...
\section{\textbf{Librarian--Surgeon Implementation}}
...
\section{\textbf{GitHub Actions Integration}}
